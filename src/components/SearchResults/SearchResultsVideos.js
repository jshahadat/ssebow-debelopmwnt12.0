...
import VideoGeneralMerge from "./ViddeoGeneralMerge";
                                        ...
                                        <div style={{ margin: "0 -15px" }}>
                                            <Slider {...cards}>
                                                {videoUrls.map((videoInfo, index) => {
                                                    return <VideoGeneralMerge key={index} videoInfo={videoInfo} style={{ borderRadius: "10px" }} />;
                                                })}
                                            </Slider>
                                        </div>
                                    </div>
